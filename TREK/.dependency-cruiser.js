  ...
  forbidden: [
    ...
    },
    {
      ...
      to: {
        ...
        pathNot: [
          '[.]css$' // Vite bundles CSS from node_modules automatically
        ]
      }
    },
    {
    ...
    // rules you might want to tweak for your specific situation:
    {
      ...
      from: {
        pathNot: [
          ...
          '[.](?:spec|test)[.](?:js|mjs|cjs|jsx|ts|mts|cts|tsx)$' // Allow test files to import from test folders
        ]
      },
      to: {
        path: '^(client/tests|server/tests)'
      }
    },
    {
      name: 'not-to-spec',
    ...
    },
    {
      ...
      from: {
        path: '^(client/src|server/src|shared)',
        pathNot: [
          '[.](?:spec|test)[.](?:js|mjs|cjs|jsx|ts|mts|cts|tsx)$',
          'vite-env[.]d[.]ts$', // Exclude Vite type definitions
          '[.]config[.](?:js|mjs|cjs|ts|mts|cts)$', // Exclude config files (eslint, tsdown, vitest, etc.)
          'eslint[.]config[.]mjs$' // Exclude ESLint flat config
        ]
      },
      to: {
        dependencyTypes: [
        ...
        pathNot: [
          'node_modules/@types/',
          'node_modules/multer/' // multer should be in dependencies, not devDependencies
        ]
      }
    },
    {
...
// generated: dependency-cruiser@17.4.3 on 2026-07-26T10:53:55.513Z
